...
public class Login extends AppCompatActivity {
    ...
    String TABELAPROPOSTA = "proposta", TABELACONSUMOMES = "consumomes", TABELAVALORES = "valores", TABELAVALORESINICIAIS = "valoresiniciais", TABELAANALISEECONIMICA = "analiseeconomica";
