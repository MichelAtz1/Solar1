...
public class ListaPropostas extends AppCompatActivity
    ...
    public void clonaDados(long idClone, String idInicial) {
        ...
        if (linhas.moveToFirst()) {
            do {
                ...
                salvaDados(totalMes1, totalMes2, totalMes3, totalMes4, totalMes5, totalMes6, totalMes7, totalMes8, totalMes9, totalMes10, totalMes11, totalMes12, medicao, idString);
            }
            while (linhas.moveToNext());
        }
        linhas.close();
    ...
    private void salvaDados(String totalMes1, String totalMes2, String totalMes3, String totalMes4, String totalMes5, String totalMes6, String totalMes7, String totalMes8, String totalMes9, String totalMes10, String totalMes11, String totalMes12, String medicao, String idDoClone) {
